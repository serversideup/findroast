...
class SyncBoyBearRoast implements ShouldQueue
{
    ...
    {
        $primaryImage = $roastData->querySelector('.section_product-header .product_image img');
    ...
    {
        $productForm = $roastData->querySelector('.product-header_product-details')->innerHTML;
