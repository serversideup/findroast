...
class SyncProdigalRoast implements ShouldQueue
{
    ...
    {
        $primaryImage = $roastData->querySelector('.product-media-container .product__media img');
    ...
    {
        $productForm = $roastData->querySelector('.product__info-wrapper')->innerHTML;
