    ...
    <section>
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6">
                ...
                <div class="mt-2 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                    <p class="text-sm text-stone-800">
                        ...
                        <Link
                            ...
                            method="post"
                            as="button"
                            class="underline text-sm text-amber-700 hover:text-amber-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500"
                        >
                    ...
                    <div
                        ...
                        class="mt-2 font-medium text-sm text-green-700"
                    >
            ...
            <div class="flex items-center gap-4">
                <PrimaryButton :disabled="form.processing" variant="amber">Save</PrimaryButton>
