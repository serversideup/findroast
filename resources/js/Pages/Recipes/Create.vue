        ...
        <div class="bg-white border-b border-gray-200">
            <div class="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between">
                    <div>
                        <Link :href="route('recipes.index')" class="text-sm text-gray-500 hover:text-gray-700 flex items-center gap-1">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                            </svg>
                            Back to Recipes
                        </Link>
                        <h1 class="mt-2 text-2xl font-bold text-gray-900">Create New Recipe</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <form @submit.prevent="submit" class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
            <div class="space-y-8">
                ...
                <div class="flex items-center justify-end gap-4">
                    <Link :href="route('recipes.index')" class="text-sm text-gray-600 hover:text-gray-900">
                        Cancel
                    </Link>
...
const form = useForm({
    ...
    is_public: true,
    steps: [
        { title: '', description: '', duration: '', water_amount: '' }
    ],
});
