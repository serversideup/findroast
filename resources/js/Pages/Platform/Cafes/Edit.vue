<template>
    <Head :title="'Edit '+cafe.name+' - ' +company.name" />
                ...
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10 pb-12">
                        ...
                        <div
                            ...
                            <div class="sm:col-span-4" v-show="!enterAddress && editPlace">
                            ...
                            <div class="sm:col-span-6 p-4 rounded border border-gray-300 bg-gray-50" v-show="placeFound">
                                ...
                                <button class="text-sm underline" type="button" @click="editLocation()">Want to edit the location?</button>
                            </div>
                           ...
                           <div class="sm:col-span-4" v-show="enterAddress">
                            ...
                            <div class="col-span-full">
                                ...
                                <div v-if="primaryImageState == 'cafe-primary-image'" class="mt-2 h-[190px] rounded-lg"
                                    :style="{
...
const primaryImageState = computed(() => {
    if( cafe.value.primary_image != null && company.value.primary_image != '' && form.primary_image == '' ){
...
const editPlace = ref(true);

if( cafe.value.google_place_id ){
...
const submit = () => {
    router.post('/platform/companies/'+company.value.id+'/cafes/'+cafe.value.id, form.data(), {
        onSuccess: () => {
