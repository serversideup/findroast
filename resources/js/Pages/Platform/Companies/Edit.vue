...
const form = useForm({
    ...
    header_image: '',
    logo: '',
    roaster: company.value.roaster,
    subscription: company.value.subscription,
    description: company.value.description,
    website: company.value.website,
    city: company.value.city,
    state: company.value.state,
    province: company.value.province,
    territory: company.value.territory,
    country: company.value.country,
    facebook_url: company.value.facebook_url,
    ...
    offerings: {
        ...
        collection_url: company.value.offering_import_map?.collection_url,
        container_selector: company.value.offering_import_map?.container_selector,
        product_list_item_selector: company.value.offering_import_map?.product_list_item_selector,
        product_list_selector: company.value.offering_import_map?.product_selector
    }
});
...
const logoState = computed(() => {
    if( company.value.logo != null && company.value.logo != ''  && form.logo == '' ){
        return 'company-logo';
    }else if( form.logo != '' ){
...
const headerState = computed(() => {
    if( company.value.header_image != null && company.value.header_image != '' && form.header_image == '' ){
        return 'company-header';
    }else if( form.header_image != '' ){
...
const submit = () => {
    router.post('/platform/companies/'+company.value.id, form.data(), {
        onSuccess: () => {
