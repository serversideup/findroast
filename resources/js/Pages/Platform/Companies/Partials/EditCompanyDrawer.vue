        ...
        <template #content>
            <div class="w-full flex flex-col space-y-3">
                ...
                <div v-show="showGeneralInformation" class="w-full flex flex-col space-y-3">
                    ...
                    <div class="w-full flex flex-col">
                        ...
                        <div class="mt-2 flex items-center gap-x-3">
                            ...
                            <div 
                                class="w-12 h-12 flex items-center justify-center" v-if="form.logo == ''">
                            ...
                            <UserCircleIcon
                                ...
                                aria-hidden="true"
                                v-show="form.logo == '' && company && company.logo == ''" />
                    ...
                    <div class="w-full flex flex-col">
                        ...
                        <div v-if="form.header_image == '' && company && company.header_image" class="mt-2 h-[190px] rounded-lg"
                            :style="{
                        ...
                        <div v-if="form.header_image != ''" class="mt-2 h-[190px] rounded-lg"
                            :style="{
                ...
                <div class="flex flex-col space-y-3" v-show="showOfferingInformation">
                    ...
                    <div class="grid grid-cols-2 gap-x-2 pb-5">
                        <SecondaryButton @click="previewScrapeResults()" class="justify-center col-span-1">Preview Scrape</SecondaryButton>
                        <PrimaryButton @click="syncOfferings()" class="justify-center col-span-1">Sync Now</PrimaryButton>
                    </div>
                </div>
            </div>
        </template>
