<template>
    ...
    <AdminHeader 
        ...
        :breadcrumbs="[
            ...
            { label: 'Amenities', to: '/platform/amenities' },
            { label: 'Edit '+amenity.name, to: '#'}
        ]"/>
    ...
    <form class="max-w-screen-xl mx-auto mt-8 flex flex-col space-y-4" @submit.prevent="submit()">
        ...
        <div class="max-w-md">
            ...
            <div class="mt-2 flex items-center gap-x-3">
                ...
                <div 
                    class="w-12 h-12 flex items-center justify-center"
                    v-if="!showIconPreview && amenity.icon != '' && amenity.icon != null">
                ...
                <PhotoIcon
                    ...
                    aria-hidden="true"
                    v-show="form.icon == '' && ( amenity.icon == '' || amenity.icon == null )" />
        ...
        <div class="max-w-md mt-6 flex items-center justify-end gap-x-6">
            <Link href="/platform/amenities" class="text-sm font-semibold leading-6 text-gray-900">Cancel</Link>
...
const amenity = computed(() => usePage().props.amenity);
...
const submit = () => {
    router.post('/platform/amenities/'+amenity.value.id, form.data(), {
        onSuccess: () => {
