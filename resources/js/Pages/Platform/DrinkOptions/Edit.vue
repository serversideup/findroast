    ...
    <form class="max-w-screen-xl mx-auto mt-8 flex flex-col space-y-4" @submit.prevent="submit()">
        ...
        <div class="max-w-md">
            ...
            <div class="mt-2 flex items-center gap-x-3">
                ...
                <div 
                    class="w-12 h-12 flex items-center justify-center"
                    v-if="!showIconPreview && drinkOption.icon != '' && drinkOption.icon != null">
                ...
                <PhotoIcon
                    ...
                    aria-hidden="true"
                    v-show="form.icon == '' && ( drinkOption.icon == '' || drinkOption.icon == null )" />
...
const drinkOption = computed(() => usePage().props.drinkOption);

const form = useForm({
    _method: 'PUT',
    name: drinkOption.value.name,
    icon: ''
});
...
const submit = () => {
    router.post('/platform/drink-options/'+drinkOption.value.id, form.data(), {
        onSuccess: () => {
